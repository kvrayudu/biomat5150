...
class Component extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ComponentName', 'length', 'max'=>255),
			array('ComponentName', 'required'),

			array('ComponentName', 'unique'),
			array('ComponentName', 'type', 'type'=>'string'),

			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ComponentName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'materialComponents' => array(self::HAS_MANY, 'MaterialComponents', 'Component_id'),
		);
	}
