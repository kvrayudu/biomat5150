...
/**
 * This is the model class for table "MaterialComponents".
 *
 * The followings are the available columns in table 'MaterialComponents':
...
class MaterialComponents extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Material_id', 'safe', 'on'=>'search'),
		);
	}
